...
public class BoundOrderRunnable implements Runnable {

	private Handler handler;
	private Map<String, String> params;
	private final String TAG = BoundOrderRunnable.class.getSimpleName();

	public BoundOrderRunnable(Handler handler, Map<String, String> params) {
	...
	private void notifyUI(JSONObject responseContent) {
		...
		try {
			...
			case 0:
				...
				msg.arg1 = InformationFragment.BOUNDORDER;
	 ...
	 * 停止该线程
	 */
	public void stopThisThread(String arg) {
		Message msg = new Message();
		msg.what = RequestResult.REQUESTERROR;
		msg.arg1 = InformationFragment.BOUNDORDER;
		msg.obj = arg;
	...
	public void run() {
		...
		try {
			HttpPost request = new HttpPost(
					DataInterfaceConstants.BOUNDORDER);
