...
public final class CameraManager {
	...
	private static final int MAX_X_FRAME_WIDTH = 600;
	private static final int MAX_X_FRAME_HEIGHT = 600;
...
//			}
			...
			// } else if(height > MAX_X_FRAME_HEIGHT){
			// height = MAX_X_FRAME_HEIGHT;
