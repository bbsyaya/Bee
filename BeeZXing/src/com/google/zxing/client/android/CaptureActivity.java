...
public final class CaptureActivity extends Activity implements
	...
	public static final boolean ISBEE = true;
	public static final int BEE_RESULT = 100;
	public static final String BEE_URL = "url";
		...
		if (handler == null) {
			...
			if (savedResultToShow != null) {
				Message message = Message.obtain(handler,
						HandlerMessage.DECODE_SUCCEEDED, savedResultToShow);
	...
	private void handleDecodeInternally(Result rawResult,
		...
		if (!ISBEE)
			...
			intent.putExtra(BEE_URL, resultHandler.getDisplayContents());
			setResult(BEE_RESULT, intent);
			finish();
		}
	...
	private void displayFrameworkBugMessageAndExit() {
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle(getString(R.string.app_name_));
	...
	public void restartPreviewAfterDelay(long delayMS) {
		if (handler != null) {
			handler.sendEmptyMessageDelayed(HandlerMessage.RESTART_PREVIEW,
					delayMS);
		}
		resetStatusView();
	}
